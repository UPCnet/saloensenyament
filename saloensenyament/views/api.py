...
class TemplateAPI(object):
    ...
    def masterTemplate(self):
        master = get_renderer('saloensenyament:templates/master.pt').implementation()
        return master
    ...
    def snippets(self):
        if self._snippets is None:
            self._snippets = get_renderer('saloensenyament:templates/snippets.pt').implementation()
