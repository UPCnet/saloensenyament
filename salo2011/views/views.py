...
from salo2011.models import MyModel

from salo2011.views.api import TemplateAPI
...
logger = logging.getLogger('salo2011')

#@view_config(context=MyModel, renderer='salo2011:templates/mytemplate.pt')
def my_view(request):
    return {'project':'salo2011'}

@view_config(context=MyModel, renderer='salo2011:templates/saloform.pt', permission='view')
